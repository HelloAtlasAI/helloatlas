      ...
      >
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <AnimatePresence mode="wait">
            <TabsContent key="search" value="search" className="mt-0">
              <motion.div 
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-lg font-semibold">Search Atlas Brain</h3>
                  <kbd className="ml-auto hidden sm:inline-flex h-5 items-center gap-1 rounded border border-border/50 bg-muted/50 px-1.5 text-[10px] text-muted-foreground">
